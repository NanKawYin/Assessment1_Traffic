...
public class Road_Obj_4Way {
    ...
    private String pic_location = "/Users/waiyanpaingoo/Desktop/Second Sem/Java/Assessment_Nan_Kaw/src/Photo/road.jpg";
    ...
    private void build_road_structure(){
        ...
        this.objAry[x][y+2] = new Road_Block(new char[]{'E','W','N'},pic_location);
        this.objAry[x][y+3] = new Road_Block(new char[]{'E','S','N'},pic_location);
        this.objAry[x][y+4] = new Road_Block(new char[]{'E','N'},pic_location);
        ...
        this.objAry[x+1][y+2] = new Road_Block(new char[]{'N','W','S'},pic_location);
        this.objAry[x+1][y+3] = new Road_Block(new char[]{'W','S','E'},pic_location);
        ...
        this.objAry[x+2][y+2] = new Road_Block(new char[]{'N'},pic_location);
        this.objAry[x+2][y+3] = new Road_Block(new char[]{'S','W'},pic_location);
